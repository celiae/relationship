...
const linksMockdata = [
  ...
  { name: "Open Issues", href: "/" },
  { name: "Wiki pages", href: "/" },
];
interface Props {
  opened: boolean;
}
export default function DoubleNavbar({ opened }: Props) {
  ...
  return (
    <Navbar hidden={!opened} width={{ sm: 300 }}>
